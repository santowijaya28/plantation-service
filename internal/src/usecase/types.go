...
type StaffUsecase interface {
	...
	GetStaffByID(ctx context.Context, idStaff int) (result model.StaffKebun, err error)
...
type KebunUsecase interface {
	InsertKebun(ctx context.Context, data model.Kebun) (result model.Kebun, err error)
	GetKebunByID(ctx context.Context, idKebun int) (result model.Kebun, err error)
	...
	GetAllBahanPerawatanKebun(ctx context.Context, filter model.FilterBahanPerawatanKebun, page, pageSize int) (data model.AllBahanPerawatanKebun, err error)

	// budidaya
	InsertBudidaya(ctx context.Context, data model.Budidaya) (result model.Budidaya, err error)
	GetBudidayaByID(ctx context.Context, idBudidaya int) (data model.Budidaya, err error)
	UpdateBudidaya(ctx context.Context, idBudidaya int, data model.Budidaya) (result model.Budidaya, err error)
	GetAllBudidayaByKebun(ctx context.Context, idKebun int, filter model.FilterBudidaya, page, pageSize int) (data []model.Budidaya, err error)

	// hasil panen
	InsertHasilPanen(ctx context.Context, data model.HasilPanen) (res model.HasilPanen, err error)
	GetHasilPanenByID(ctx context.Context, idPanen int) (res model.HasilPanen, err error)
	GetAllHasilPanen(ctx context.Context, filter model.FilterHasilPanen, page, pagesize int) (data model.AllHasilPanen, err error)
	UpdateHasilPanen(ctx context.Context, data model.HasilPanen) (res model.HasilPanen, err error)
}

type BahanPerawatanUsecase interface {
...
type KomoditasUsecase interface {
...
type PerawatanTanamanUsecase interface {
	InsertPerawatanTanaman(ctx context.Context, data model.PerawatanTanaman) (result model.PerawatanTanaman, err error)
	GetByID(ctx context.Context, idPerawatanTanaman int) (data model.PerawatanTanaman, err error)
